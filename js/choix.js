...
statbar[0].style.background = "linear-gradient(90deg, red " + (health*10) + "%, white " + (health*10) + "%)";
statbar[1].style.background = "linear-gradient(90deg, red " + (wealth*10) + "%, white " + (wealth*10) + "%)";
statbar[2].style.background = "linear-gradient(90deg, red " + (social*10) + "%, white " + (social*10) + "%)";
...
var events = [
...

    {
        ...
        "choix3":"Vous décidez de ne pas vous laisser faire et menacez le voleur./-1.-1.-1/Vous avez réussi à récupérer une partie de vos économies. Néanmoins, vous avez été blessé dans la confrontation.<br>Vous perdez 1 point de bourse, 1 point de santé et 1 point de sociabilité."
    },

    {
        "id":"2",
        "bg":"url('img/bg2.jpg')", 
        "skin":"img/goodboi.png",
        ...
        "choix3":"Vous abandonnez votre repas et décidez de compenser en volant de la nourriture ailleurs./+1.0.-1/Le marchand vous surprend presque la main dans le sac ! Vous parvenez toutefois à vous échapper avec la nourriture.<br>Vous gagnez 1 point de santé mais perdez 1 point de sociabilité."
    },
